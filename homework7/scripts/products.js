...
products.forEach(({ id, title, price, image, country }) => {
    ...
    productCard.append(imageElem, titleElem, priceElem, countryElem, buyButtonElem);
    products_container.append(productCard);

    if (image ==="https://img.freepik.com/premium-vector/sold-tag-icon-for-product-auction-isolated-vector_32996-2098.jpg") {

    }
});
const productCard = document.querySelector(".productCard")
function clickButton(g) {
